...
public class EmbeddedServerServiceRegistryImpl implements EmbeddedServerServiceRegistry {
    ...
    @Override
    public EmbeddedServerService getService(Integer serverPort) {
        return embeddedServerServices.get(serverPort);
    }

...
public class DirectoryContainerArchive implements ContainerArchive {
    ...
    private final static String[] AKR_CONTAINER_JAR = { "aopalliance-1.0", "commons-io-2.7",
            ...
            "netty-all-4.1.94.Final", "netty-transport-4.1.109.Final", "netty-common-4.1.109.Final",
            "netty-handler-4.1.109.Final", "netty-codec-4.1.109.Final", "netty-buffer-4.1.109.Final",

...
public class ArkPluginAction implements Action<Project> {
    ...
    public void execute(Project project) {
        ...
        configureArkAllArtifact(project);
        TaskProvider<ArkJar> arkJar = configureBootJarTask(project);
    ...
    private TaskProvider<ArkJar> configureBootJarTask(Project project) {
        ...
        TaskProvider<ArkJar> arkBizJarTaskProvider =  project.getTasks().register(SofaArkGradlePlugin.ARK_BIZ_TASK_NAME, ArkJar.class, (arkJar) -> {
